...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-item nav-link" href="tech_homepageNULL.php">Homepage <span class="sr-only">(current)</span></a>
      <a class="nav-item nav-link" href="requestNULL.php">Request</a>
        <a class="nav-item nav-link" href="technotifNULL.php">Notification</a>
        <a class="nav-item nav-link" href="../login.php">Log Out</a>
    </div>
  </div>
</nav>
	<form action="requestNULL.php" method="post">
		<center><h1>Do you want to request approval for your account?</h1><br>
		<input type="submit" name="yes" value="REQUEST"></center>
	</form>
	<?php 
