...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
    ...
    <body>
        ...
        <form action = "checkinfostudent.php" method = "post">
          <h1>Information</h1>
  ...
  elseif(isset($_POST['back'])) {
   ...
   function display(){//BEGINNING OF DISPLAY
     ...
     define('DB_SERVER','cpe7520.db.11808498.952.hostedresource.net');
      ...
      echo "<br/><tr><th>Last Name</th><th>First Name</th><th>Middle Name</th><th>Birthdate</th><th>Course</th><th>Present Address</th><th>Permanent Address</th><th>Home Phone</th><th>Mobile No.</th><th>Email</th><tr>";

      if($labtype == "ceac-tc"){
          $query ="SELECT * FROM ceac_studentvolunteers WHERE username = '$username'"; 
          ...
          echo "<td align=center>".$row['presentaddress']."</td>";
          echo "<td align=center>".$row['permanentaddress']."</td>";
      ...
      if($labtype == "ncr"){
          $query ="SELECT * FROM ncr_studentvolunteers WHERE username = '$username'"; 
      ...
      if($labtype == "dml"){
          $query ="SELECT * FROM dml_studentvolunteers WHERE username = '$username'"; 
      ...
      if($labtype == "secn"){
          $query ="SELECT * FROM secn_studentvolunteers WHERE username = '$username'"; 
      ...
      if($labtype == "pcb-cra"){
          $query ="SELECT * FROM pcb_studentvolunteers WHERE username = '$username'"; 
